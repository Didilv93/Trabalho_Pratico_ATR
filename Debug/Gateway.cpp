...
int c = -1;
int nClient = -1; // primeiro cliente ocupa a posi��o 0
...
void retiraUsuarioDaLista(position_t usuario)
{
	...
	for (int j = 0; j < nClient; j++)
	{
		// Retira o usu�erio da lista puxando todos os usu�rios "para o inicio" em 1 posi��o
	...
	void do_read()
	{
			...
			[this, self](boost::system::error_code ec, std::size_t length)
		{
			if (!ec)
			{
				...
				string hold[17];  //Ser�o lidos 17 tokens
				int countTokens = 0;
